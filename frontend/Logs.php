...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="JS/main_logs.js"></script>
    <title>ProxyUdec - Logs </title>
  ...
  <body>
      ...
      <main role="main" class="container" style="width: 85%;margin-left:10% ; margin-right:7%">
        <center><h4 id="titulo">Logs</h4></center>
        <div id="tablaajuste">
            <table class="table" style="width: 95%;">
                <thead class="table-warning" id="EncabezadoTabla">
                  <tr>
                    <th scope="col">Id</th>
                    <th scope="col">User Agent</th>
                    <th scope="col">Tcp Log</th>
                    <th scope="col">Ip</th>
                    <th scope="col">Fecha</th>
                    <th scope="col">Metodo</th>
                    <th scope="col">URL</th>
                    <th scope="col">Codigo respuesta</th>
                    <th scope="col">Size</th>
                    <th scope="col">Redireccion</th>
                    <th scope="col">Version HTTP</th>
                  </tr>
                </thead>
      ...
      <div class="footer_2">
        ...
        <svg width="3em" height="em" viewBox="0 0 16 16" class="bi bi-binoculars-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
