...
<html lang="en">
  <head>
    ...
    <!--Archivos internos de js-->
    <script type="text/javascript" src="JS/RecargaPagina.js"></script>
    <script type="text/javascript" src="JS/Grafico1.js"></script>
    <title>ProxyUdec - Graficos Estadisticos</title>
  ...
  <body>
      ...
      <ul class="nav nav-pills nav-fill" id="menu">
        <li class="nav-item">
            <a class="nav-link" href="MapadeCalor.php">
              Mapa de calor
        ...
        <li class="nav-item">
            <a class="nav-link" href="GraficosEstadisticos.php">
      ...
      <main role="main" class="container" >
        <center><h4 id="titulo">Graficos Estadisticos</h4></center>
        <div id="cuerpo">
            <div class="container">
                <div class="row">
                  <div class="col columna">
                      <h3 style="color:rgba(192, 57, 43, 0.5);">IP's con mayor cantidad de peticiones</h3>
                      <canvas id="myChart" class="grafico1"></canvas>

                  </div>
                  <div class="col columna">
                      <h3>Navegadores mas usados</h3>
                      <canvas id="GraficoPolar" class="grafico1"></canvas>
                  </div>
                  <div class="w-100"></div>
                  <div class="col columna">
                    <h3>Sitios mas visitados</h3>
                    <canvas id="GraficoRosca" class="grafico1">
                </div>
                  <div class="col columna">
                      <h3>Sistemas operativos mas usados</h3>
                      <canvas id="GraficoLineal" class="grafico1"></canvas>
                    </div>
                </div>
              </div>
        </div>
      ...
      <div class="footer_2">
        <p>ProxyUdec creado por:</br><i>Maria Alejandra Calderon Duque & Kevin David Quiroga Astroz</i></p>
        <svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-binoculars-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
